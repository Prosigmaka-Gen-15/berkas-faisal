...
const Header = (props) => {
  ...
  return (
    <div className="w-full px-6 py-2 flex flex-row justify-between content-center drop-shadow-xl bg-white">
      ...
      <div className="hidden md:hidden lg:flex 2xl:flex xl:flex flex-row gap-4 items-center">
        <a className="cursor-pointer hover:opacity-50">{user.email}</a>
        {user.id != "" ? (
          <>
            <a
          ...
          <>
            <button
              className="bg-green-600 text-white font-semibold px-4 py-1 rounded flex justify-center items-center"
